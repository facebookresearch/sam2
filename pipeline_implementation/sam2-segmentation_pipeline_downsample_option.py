...
def segment_object(pil_image, points, predictor, downsample_factor):
    ...
    with torch.inference_mode(), torch.autocast(device_type="cuda", dtype=torch.bfloat16):
        ...
        input_points = input_points * downsample_factor
    ...
    try:
        ...
        with tiff.TiffWriter(output_file_path, bigtiff=True) as tif_writer:
            ...
            for i, img in enumerate(tif):
                ...
                mask = segment_object(img, [extracted_coordinates[column][i] for column in column_names], predictor, downsample_factor)
